...
linkFavIcon.setAttribute("type", "Imagenes/x-icon");
...
container.style.backgroundImage = "url(/Imagenes/cenario.png)";
...
sky.style.backgroundImage = "url(/Imagenes/cenarioceu.png)";
...
imageMenu.src = "/Imagenes/menuDoJogo.png";
...
mario.style.backgroundImage = "url(/Imagenes/marioParadoLadoDireito.png)";
...
enemy.style.backgroundImage = "url(/Imagenes/inimigoLadoEsquerdo.gif)";
...
block.style.backgroundImage = "url(/Imagenes/bloco.png)";
block.style.backgroundRepeat = "no-repeat";
block.style.backgroundPosition = "center";
block.style.backgroundSize = "100% 100%";
block.style.bottom = "250px"
block.style.right = "400px"
...
function timing() {
    ...
    if (timerCurrent === 100) {
        ...
        mario.style.backgroundImage = "url(/Imagenes/marioMorto.gif)";
        audioJump.volume = 0;
...
function handleKeydown(event) {
    if (event.key === "ArrowRight") {
        direction = +10;
        mario.style.backgroundImage = "url(/Imagenes/marioAndandoLadoDireito.gif)";
    } else if (event.key === "ArrowLeft") {
        direction = -10;
        mario.style.backgroundImage = "url(/Imagenes/marioAndandoLadoEsquerdo.gif)";
...
function handleKeyup(event) {
    if (event.key === "ArrowRight") {
        ...
        direction = -0;
        mario.style.backgroundImage =  "url(/Imagenes/marioParadoLadoEsquerdo.png)";
    }
}
